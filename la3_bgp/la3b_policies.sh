...
if [[ $ACTION =~ ^(all|add)$ ]] ; then
  ...
  echo "Connect R1 and R2 to interconnection network"
  docker network connect --ip 10.0.$((X+100)).10 net$((X+100)) R1
  docker network connect --ip 10.0.$((X+100)).20 net$((X+100)) R2
